  ...
  const lineup = [
    {
      ...
      links: [
        {
          icon: "instagram-logo",
          href: "https://www.instagram.com/albans.world/",
        },
                  ...
                  <div class="collapse-content text-sm">
                    <div class="flex">
                      ...
                      <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                        class="reveal-svg order-1 md:order-2 aspect-ratio-2/3 height-[40rem] max-w-full max-h-full"
                      >
                        <defs>
