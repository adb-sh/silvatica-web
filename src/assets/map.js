!(function () {
  ...
  // ])
  //   .addTo(map)
  //   .bindPopup("<b>Parken + Van-Camping</b>");
  ...
  //   iconAnchor: [15, 15],
  // });
  // L.marker([49.10167207285711, 9.801660013726533], { icon: myIcon, alt: "WCs" })
  //   .addTo(map)
  //   .bindPopup("<b>WCs</b>", { minWidth: 20 });
  // L.marker([49.10203947743715, 9.800081054503767], { icon: myIcon, alt: "WCs" })
  //   .addTo(map)
  //   .bindPopup("<b>WCs</b>", { minWidth: 20 });

  // // Entrance
  // L.marker([49.10347742083176, 9.799590040395572])
  //   .addTo(map)
  //   .bindPopup("<b>Einfahrt</b>")
  //   .openPopup();
})();
